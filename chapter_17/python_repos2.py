# refactored python repos visualization
...
def get_repo_dicts(r):
    """return a set of dicts with the most popular repos"""
...
def make_graph(repo_links, stars, labels):
    """generate the graph for most starred repos"""
    data =[{
        'type': 'bar',
        'x': repo_links,
        'y': stars,
...
if __name__ == '__main__':
    ...
    make_graph(repo_links, stars, labels)